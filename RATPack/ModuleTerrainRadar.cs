...
namespace RATPack
{
    public class ModuleTerrainRadar : PartModule
    {
        ...
        private Texture2D _scaleGraph;
        private Texture2D _terrain;
        private Texture2D _terrainLateral;
        ...
        public override void OnAwake()
        {
            ...
            _scaleGraph = new Texture2D(20, 300);
            _terrain = new Texture2D(300, 300);
            _terrainLateral = new Texture2D(300, 100);
